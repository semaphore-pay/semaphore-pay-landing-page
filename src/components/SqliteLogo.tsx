...
interface SQLiteLogoProps extends React.SVGProps<SVGSVGElement> {
  className?: string
}

export default function SQLiteLogo({ className, ...props }: SQLiteLogoProps) {
  return (
    <svg
      viewBox="0 0 32 32"
    ...
    >
      ...
      <path
        ...
        style={{ fill: "url(#sqlite-gradient-a)" }}
      />
      <path
